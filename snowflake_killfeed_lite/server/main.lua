...
local function getPlayerFullName(playerId)
...
local function getDisplayName(playerId)
    ...
    return getPlayerFullName(playerId) or GetPlayerName(playerId)
end
...
CreateThread(function()
    print('^2[Snowflake Studios]^0 Killfeed Lite v1.0.0 loaded successfully')
